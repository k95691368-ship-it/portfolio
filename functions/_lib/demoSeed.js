...
export const DEMO_POSTING = {
  ...
  workHoursEnd: '18:00',
  workDays: '주 5일 (월~금)',
  description: `한빛테크 플랫폼팀에서 함께할 백엔드 개발자를 찾습니다.
...
//   6) 공고보다 불리 — 공고는 09~18시·주5일·최소 260만원인데 계약은
//      09~20시·주6일·190만원. 채용절차법 제4조 제3항.
...
export const DEMO_MESSAGES = {
  ...
  pending: [
    ...
    ['candidate', '임금도 공고에 적힌 260만원보다 낮은 것 같습니다. 다시 확인 부탁드립니다.'],
  ],
  previous: [
